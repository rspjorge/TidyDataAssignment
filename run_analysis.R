...
unzip(zipfile="~/DataScience-CURSO/Getting-Cleaning-Data/week4/Assignment/Dataset.zip")
...
filesPath <- "~/DataScience-CURSO/Getting-Cleaning-Data/week4/Assignment/UCI HAR Dataset"
